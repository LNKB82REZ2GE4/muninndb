	...
	return []ToolDefinition{
		{
			...
			InputSchema: map[string]any{
				...
				"properties": map[string]any{
					...
					"created_at":  map[string]any{"type": "string", "description": "ISO 8601 timestamp for when this memory was created (transaction time). Defaults to now. Use to seed memories at past or future times."},
