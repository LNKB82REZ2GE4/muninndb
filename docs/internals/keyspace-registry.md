...
`0x32`–`0x3F` and `0x47`+ are free for new storage/auth keys (0x2B–0x2E and 0x31
are now allocated: 0x2B evolve-repair watermark (#681), 0x2C raw-tag-range index (S1),
0x2D armed-intention index (THE PUSH), 0x2E full-weight assoc-key repair watermark
(#756), 0x31 declared-contradiction marker;
0x40–0x45 are allocated: 0x40/0x41 capability, 0x42–0x45 auth).
